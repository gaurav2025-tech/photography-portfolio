...
```bash
git remote add encore encore://photography-portfolio-ocyi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/photography-portfolio-ocyi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/photography-portfolio-ocyi/settings/integrations/github)
